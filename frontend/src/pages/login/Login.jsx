...
const Login = () =>{
    ...
    return <div className="flex items-center justify-center flex-col mx-auto min-w-96">
        <h1 className="text-4xl text-lime-800 font-bold">Login</h1>
        <div className="w-full p-6 flex-col flex">
            ...
            <div className="text-black flex justify-center text-sm mb-1">Don't have an account.
                <a href="#" className="font-bold">Signup </a>
            </div>

            <button type="button" onClick={handleLogin()} className="text-white font-medium rounded-lg text-sm px-5 py-2.5  my-3 bg-green-800 hover:bg-green-900 ">Login</button>
        </div>
    </div>
}
